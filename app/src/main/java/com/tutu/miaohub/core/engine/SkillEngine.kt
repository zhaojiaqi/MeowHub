...
import com.tutu.miaohub.core.model.StepBranch
...
class SkillEngine(
    ...
    private val apiClient: MiaoHubApiClient,
    ...
    private val _currentSkill = MutableStateFlow<MiaoSkillDetail?>(null)
    val currentSkill: StateFlow<MiaoSkillDetail?> = _currentSkill.asStateFlow()
     ...
     */
    private fun extractInitialTargetPackage(skill: MiaoSkillDetail): String? {
...
"""
    ...
    private fun buildSummaryText(aiOutputs: List<String>, skill: MiaoSkillDetail): String {
