package com.tutu.miaohub.core.service
...
import com.tutu.miaohub.MainActivity
import com.tutu.miaohub.R
import com.tutu.miaohub.core.engine.SkillEngine
import com.tutu.miaohub.feature.overlay.OverlayContent
import com.tutu.miaohub.feature.overlay.ResultOverlayContent
...
class MiaoOverlayService : Service() {
    ...
    private fun showOverlay() {
        ...
        val composeView = ComposeView(this).apply {
            ...
            setContent {
                OverlayContent(
                    client = MiaoApp.instance.tutuClient,
                    onDragUpdate = { dx, dy ->
                        params.x += dx.toInt()
                        params.y += dy.toInt()
    ...
    private fun buildNotification(): Notification {
        ...
        val stopIntent = PendingIntent.getService(
            this, 1,
            Intent(this, MiaoOverlayService::class.java).apply { action = ACTION_STOP },
            PendingIntent.FLAG_IMMUTABLE
        )
    ...
    companion object {
        const val CHANNEL_ID = "miao_overlay"
        const val NOTIFICATION_ID = 1001
        const val ACTION_STOP = "com.tutu.miaohub.STOP_OVERLAY"

        fun start(context: Context) {
            context.startForegroundService(
                Intent(context, MiaoOverlayService::class.java)
            )
        }
