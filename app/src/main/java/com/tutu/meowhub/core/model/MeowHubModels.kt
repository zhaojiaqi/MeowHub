...
@Serializable
data class MeowSkillListResponse(
    val success: Boolean,
    val list: List<MeowSkillItem> = emptyList(),
    val total: Int = 0,
    val page: Int = 1,
    val limit: Int = 12,
...
@Serializable
data class MeowSkillDetailResponse(
    val success: Boolean,
    val data: MeowSkillDetail? = null,
    val message: String? = null
)

@Serializable
data class MeowSkillDetail(
    val id: Int = 0,
    val slug: String = "",
    @SerialName("display_name") val displayName: String = "",
    @SerialName("display_name_en") val displayNameEn: String = "",
