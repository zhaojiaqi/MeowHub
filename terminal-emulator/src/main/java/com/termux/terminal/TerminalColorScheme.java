...
public final class TerminalColorScheme {
    ...
    private static final int[] DEFAULT_COLORSCHEME = {
        ...
        0xff0a0e14, // black (matches terminal bg)
        0xffff3333, // dim red
        0xff00cc66, // dim green
        0xffe6db74, // dim yellow
        0xff66d9ef, // dim blue
        0xffae81ff, // dim magenta
        0xff56d4bc, // dim cyan
        0xffc0c5ce, // dim white
        // Second 8 are bright:
        0xff546e7a, // medium grey
        0xffff5555, // bright red
        0xff00ff41, // bright green (matrix green)
        0xfff4f99d, // bright yellow
        0xff78dce8, // light blue
        0xffff6ac1, // bright magenta
        0xff5ef1e6, // bright cyan
        0xfff8f8f2, // bright white
        ...
        0xff00ff41, 0xff0a0e14, 0xff00ff41};
